...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '语料表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of kg_corpus
-- ----------------------------
INSERT INTO `kg_corpus` VALUES (1, 1, '示例语料', '张三是阿里巴巴的工程师，他参与了双11购物节活动的筹备工作。阿里巴巴位于杭州市。', '示例', 1, '2026-04-12 05:45:51', '2026-04-12 05:45:51');

-- ----------------------------
-- Table structure for kg_entity_type
-- ----------------------------
DROP TABLE IF EXISTS `kg_entity_type`;
CREATE TABLE `kg_entity_type`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `project_id` bigint NOT NULL COMMENT '项目ID',
  `name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '实体类型名称',
  `color` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '#409EFF' COMMENT '显示颜色',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_project_id`(`project_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '实体类型表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of kg_entity_type
-- ----------------------------
INSERT INTO `kg_entity_type` VALUES (1, 1, '人物', '#409EFF', NULL, '人物实体', '2026-04-12 05:45:51', '2026-04-12 05:45:51');
INSERT INTO `kg_entity_type` VALUES (2, 1, '地点', '#67C23A', NULL, '地点实体', '2026-04-12 05:45:51', '2026-04-12 05:45:51');
INSERT INTO `kg_entity_type` VALUES (3, 1, '组织', '#E6A23C', NULL, '组织机构', '2026-04-12 05:45:51', '2026-04-12 05:45:51');
INSERT INTO `kg_entity_type` VALUES (4, 1, '事件', '#F56C6C', NULL, '事件实体', '2026-04-12 05:45:51', '2026-04-12 05:45:51');

-- ----------------------------
-- Table structure for kg_project
-- ----------------------------
...
CREATE TABLE `kg_project`  (
  ...
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '知识图谱项目表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of kg_project
-- ----------------------------
INSERT INTO `kg_project` VALUES (1, '示例知识图谱项目', '这是一个示例知识图谱项目，用于演示系统功能', 1, 1, '2026-04-12 05:45:50', '2026-04-12 05:45:50');

-- ----------------------------
-- Table structure for kg_relation_type
-- ----------------------------
DROP TABLE IF EXISTS `kg_relation_type`;
CREATE TABLE `kg_relation_type`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `project_id` bigint NOT NULL COMMENT '项目ID',
  `name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '关系类型名称',
  `source_entity_type_id` bigint NULL DEFAULT NULL COMMENT '源实体类型ID',
  `target_entity_type_id` bigint NULL DEFAULT NULL COMMENT '目标实体类型ID',
  `description` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '描述',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_project_id`(`project_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '关系类型表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of kg_relation_type
-- ----------------------------
INSERT INTO `kg_relation_type` VALUES (1, 1, '位于', 2, 2, '地点之间的位置关系', '2026-04-12 05:45:51', '2026-04-12 05:45:51');
INSERT INTO `kg_relation_type` VALUES (2, 1, '属于', 1, 3, '人物属于某个组织', '2026-04-12 05:45:51', '2026-04-12 05:45:51');
INSERT INTO `kg_relation_type` VALUES (3, 1, '参与', 1, 4, '人物参与某个事件', '2026-04-12 05:45:51', '2026-04-12 05:45:51');
INSERT INTO `kg_relation_type` VALUES (4, 1, '发生地', 4, 2, '事件发生的地点', '2026-04-12 05:45:51', '2026-04-12 05:45:51');
...
INSERT INTO `sys_menu` VALUES (20, '图谱项目管理', 0, 2, '', 1, '2026-04-12 13:31:49', '2026-04-12 13:31:49', '/kg/project', 'Share');
INSERT INTO `sys_menu` VALUES (21, '图谱模型管理', 0, 3, '', 1, '2026-04-12 13:31:49', '2026-04-12 13:31:49', '/kg/model', 'Connection');
INSERT INTO `sys_menu` VALUES (22, '知识图谱探索', 0, 4, '', 1, '2026-04-12 13:31:49', '2026-04-12 13:31:49', '/kg/explore', 'DataLine');
INSERT INTO `sys_menu` VALUES (23, '语料管理', 0, 5, '', 1, '2026-04-12 13:31:49', '2026-04-12 13:31:49', '/kg/corpus', 'Document');
INSERT INTO `sys_menu` VALUES (24, '数据导入', 0, 6, '', 1, '2026-04-12 13:31:49', '2026-04-12 13:31:49', '/kg/transform', 'Upload');
...
INSERT INTO `sys_role_menu` VALUES (138, 1, 20);
INSERT INTO `sys_role_menu` VALUES (139, 1, 21);
INSERT INTO `sys_role_menu` VALUES (140, 1, 22);
INSERT INTO `sys_role_menu` VALUES (141, 1, 23);
INSERT INTO `sys_role_menu` VALUES (142, 1, 24);
...
INSERT INTO `sys_user` VALUES (4, '9rui', '$2a$10$a0Kq0BQuA1DLXJZ.zBCXjOoFrpC5fUgMomrpRo1DPq3yONVrulNHC', 1, '2026-04-12 14:25:23', '2026-04-12 14:25:23');
...
INSERT INTO `user` VALUES (2036697781578477569, 'programmer1774421565719', '批量测试用户', '$2a$10$UY.7LEgDUL/8RW8qy.Jgg.vJrPCWkWdroibv497lvCA6p/qvnH7u6', 'programmer1774421565719@example.com', 'https://api.dicebear.com/7.x/avataaars/svg?seed=programmer1774421565719', 0, 1, '2026-03-25 14:52:46', '2026-03-25 14:52:46');
